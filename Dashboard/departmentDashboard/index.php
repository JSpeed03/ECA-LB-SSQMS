...
// Prepare and execute the query to fetch the department name
...
// Store the department name in session
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?php echo $department_name;?> Dashboard</h1>
      </div>
      ...
      <form action="update_time_called.php" method="post">
    <?php
    $sql1 = "SELECT `Queue identifier` FROM queue WHERE `Time Created` = (SELECT MIN(`Time Created`) ) AND Status='Pending' AND Department_ID = '$department_id'";
    ...
    if ($result1) {
        ...
        if ($row) {
            ...
            $id = $row['Queue identifier'];
            ?>
            <input type="hidden" name="queue_id" value="<?php echo $id; ?>">
            <?php
        } 
    } else {
...
<form action="Call Again.php" method="POST">
<?php
    $sql1 = "SELECT `Queue identifier` FROM queue WHERE `Time Created` = (SELECT MIN(`Time Created`) ) AND Status='Called' AND Department_ID = '$department_id'";
    $result1 = mysqli_query($conn, $sql1);

    if ($result1) {
        // Fetch the associative array containing the result
        $row = mysqli_fetch_assoc($result1);
        ...
        echo "alert('Query failed.');"; // Use JavaScript alert for query failure
    }
    ?>
