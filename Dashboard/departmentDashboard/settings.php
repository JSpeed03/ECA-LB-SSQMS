...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?php echo $department_name;?> Settings</h1>
      </div>

    
		<i class='bx bxs-error train' ></i>
  <p class="cookieHeading">Change Password</p>
  <form action="change.php" method="POST">

  <div class="cmd-1">
    <label for="inputEmail" class="form-label">Password</label>
    <input type="text" class="form-control" name="new" placeholder="Input Password">
  </div>
  <div class="md-1">
  ...
  <div class="buttonContainer">
    ...
    <button class="acceptButton" name="deletedata" type="submit">Change Password</button>
