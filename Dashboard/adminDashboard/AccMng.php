...
.form-control::placeholder {
  ...
  <body>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="diplays">
		<div class="cards">
		<i class='bx bxs-error train' ></i>
  <p class="cookieHeading">Delete User</p>
  <form action="delete.php" method="POST">
  <div class="md-1">
    <input type="hidden" class="form-control" id="delete_id" name="deletedata" placeholder="Input User Name" >
  </div>
  <div>
    <h2 class="cookieHeadings" text-align="center">Are You sure you want to Delete this Account?</h2>
  </div>
<button type="submit">Yes</button>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="card">
		<i class='bx bxs-error train' ></i>
  <p class="cookieHeading">Add User</p>
  ...
  <div class="buttonContainer">
    ...
    <button class="acceptButton" name="deletedata" type="submit">Add User</button>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="AccMng.php">
