...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page"  href="Department.php">
    ...
    <input type="text" id="DepartmentCode" name="DepartmentCode" required placeholder="Department Code" required><br><br>
    <input type="text" id="DepartmentDescription" name="DepartmentDescription" required placeholder="Department Description" required><br><br>
